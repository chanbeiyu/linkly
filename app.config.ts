...
export const IconNames = {
  Tabler: {
    ...
    RADAR: 'icon-[tabler--radar]',
    READING: 'icon-[tabler--book]',
...
export const USER_CMS_NAV_LINKS = [
  ...
  {
    label: '稍后阅读',
    href: PageRoutes.User.READ_LATER,
    icon: IconNames.Tabler.READING,
    description: '保存待阅读链接并沉淀文章摘要',
